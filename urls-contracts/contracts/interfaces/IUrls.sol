...
interface IUrls {
    ...
    /// @notice Emitted when a Urls token is bought
    ...
    /// @notice Emitted when a Urls token is sold
    ...
    /// @notice Emitted when Urls tokens are transferred
    ...
    /// @param orderReferrer The address of the order referrer
    /// @param originFeeRecipient The address of the origin fee recipient
    ...
    /// @param originFee The fee for the origin
    ...
    /// @dev Emits a UrlsTokenTransfer event with the updated token balances and total supply
